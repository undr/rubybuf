...
describe Rubybuf::Message::Field::Fixed64 do
  before(:each) do
  ...
  context ".valid_value_type?" do
    ...
    it "returns false if value isn't valid" do
      [12.3, "string", Object.new, :symbol, Rubybuf::Message::Field::UINT64_MAX + 1, -12].each do |value|
  ...
  context ".write_to" do
    it "writes value to writer" do
      ...
      writer.rewind
      writer.read.should == "\226\000\000\000\000\000\000\000"
      writer = StringIO.new
      @field.write_to(writer, Rubybuf::Message::Field::UINT64_MAX)
      writer.rewind
      writer.read.should == "\377\377\377\377\377\377\377\377"
    end
  end
  context ".read_from" do
    it "reads value from reader" do
      ...
      reader = StringIO.new("\226\000\000\000\000\000\000\000")
      @field.read_from(reader).should == 150
      reader = StringIO.new("\377\377\377\377\377\377\377\377")
      @field.read_from(reader).should == Rubybuf::Message::Field::UINT64_MAX
    end
  end
end